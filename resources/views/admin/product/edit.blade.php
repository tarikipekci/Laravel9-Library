                            ...
                            <div class="panel-body">
                                <form role="form" action="{{route('admin.product.update', ['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="category_id" style="...">
                                                @foreach($datalist as $rs)
                                                    <option value="{{$rs->id}}" @if($rs->id == $data->category->id) selected="selected" @endif">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" placeholder="Price" name="price" value="{{$data->price}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" placeholder="Amount" name="amount" value="{{$data->amount}}">
                                        <p class="help-block"></p>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" placeholder="Number of Pages" name="page" value="{{$data->page}}">
                                        <p class="help-block"></p>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class ="form-group">
                                            ...
                                            <select class ="form-control" name="status">
                                                ...
                                                <option>True</option>
                                                <option>False</option>                                                                 value="{{$data->description}}
